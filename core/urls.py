...
urlpatterns = [
    ...
    path('orders/<int:pk>/conference/captions/toggle/', views.captions_toggle, name='captions_toggle'),
    path('orders/<int:pk>/conference/captions/translate/', views.captions_translate, name='captions_translate'),
